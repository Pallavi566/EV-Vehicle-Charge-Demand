...
st.markdown("""
    <div style='text-align: left; font-size: 22px; padding-top: 10px; color: #FFFFFF;'>
        <span style='color: black;'>Select a county and see the forecasted EV adoption trend for the next 3 years.</span>
    </div>
""", unsafe_allow_html=True)
...
ax.set_title(f"Cumulative EV Trend - {county} (3 Years Forecast)", fontsize=14, color='black')
ax.set_xlabel("Date", color='black')
ax.set_ylabel("Cumulative EV Count", color='black')
...
if multi_counties:
    ...
    ax.set_title("EV Adoption Trends: Historical + 3-Year Forecast", fontsize=16, color='black')
    ax.set_xlabel("Date", color='black')
    ax.set_ylabel("Cumulative EV Count", color='black')
    ax.grid(True, alpha=0.3)
    ax.set_facecolor("#fdfdfd")
